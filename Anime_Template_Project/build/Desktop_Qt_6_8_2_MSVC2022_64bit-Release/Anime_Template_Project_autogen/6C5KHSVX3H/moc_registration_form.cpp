...
static constexpr auto qt_meta_stringdata_ZN17Registration_formE = QtMocHelpers::stringData(
    "Registration_form",
    "execute_animation",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17Registration_formE[] = {
...
Q_CONSTINIT const QMetaObject Registration_form::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17Registration_formE.offsetsAndSizes,
    qt_meta_data_ZN17Registration_formE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17Registration_formE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Registration_form, std::true_type>,
...
void *Registration_form::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17Registration_formE.stringdata0))
