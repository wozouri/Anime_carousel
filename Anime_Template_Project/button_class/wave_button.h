...
{
    Q_OBJECT
    Q_PROPERTY(int angle READ angle WRITE setAngle   FINAL)
    Q_PROPERTY(int wave_position READ wave_position WRITE setWave_position   FINAL)
    Q_PROPERTY(int wave_transparency READ wave_transparency WRITE setWave_transparency   FINAL)
    Q_PROPERTY(int right_angle READ right_angle WRITE setRight_angle   FINAL)
public:
