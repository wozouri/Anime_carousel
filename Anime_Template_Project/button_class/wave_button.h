...
public:
    ...
    void rotating_rounded_rectangle(); // 顺时针 绘制旋转的圆角矩形
    void rotating_rounded_rectangle1(); // 逆时针 绘制旋转的圆角矩形
    ...
    double triangle_position(); // 直角三角形的斜边长度的一半
...
private:
    ...
    int m_wave_position = 0; // 波纹位置
    int m_wave_transparency = 100; // 波纹透明度
